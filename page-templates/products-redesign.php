<?php 
/**
 * Template Name: Products Redesign
*/
get_header(); ?>
...
<section class="container-fluid wrap push">
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 prod-intro-content">
			<?php the_field('prod_intro_content'); ?>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 prod-intro-video">
			<?php the_field('prod_intro_video'); ?>
		</div>
	</div>
</section>

<section class="container-fluid lightGray-bg as-wrapper wrap push" id="management-console">
	<div class="container">
...
<section class="container-fluid as-wrapper wrap push" id="mobile-auditor">
	<div class="container">
		<div class="container">
