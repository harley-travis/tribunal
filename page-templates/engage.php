...
<!--
	<video id="vid-bg" class="engage-vid-bg" autoplay loop width="100%" height="100%">
		<source src="https://rizepoint.com/wp-content/uploads/2017/04/engage-2018.webm" type="video/webm">
		<source src="https://rizepoint.com/wp-content/uploads/2017/05/engage-header-exploer.mp4" type="video/mp4">
	</video>
-->
	...
	<div class="container banner wrap push">
		<div class="banner-wrapper">
			...
			<div class="banner-btns">
				<a class="btn btn-lg btn-inverse-white" data-toggle="modal" data-target="#engage-promo">Watch The Video</a>
			</div><!-- banner-btns -->
		</div><!-- banner-wrapper -->
	</div><!-- banner -->
</div><!-- container-fluid -->
...
<div class="container-fluid e2018-venue wrap push">
	<div class="container e2018-venue-wrapper">
		...
		<p>The conference space is steps from the guest room elevators, so you won’t have to walk a mile in anyone’s shoes (unless you want to). There are tigers in the backyard, a volcano out front, luxury rooms, amazing dining venues, and top-rated amenities. Our Engage 2018 room block offers special discounted pricing: $110 per night (plus resort fee and tax). Room reservations will launch with registration soon!</p>
		...
		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			...
			<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
			  <div class="panel-body">
				<div class="panel-section">
					<h3>Product Roadmap—a complete view of RizePoint product development plans</h3>
					<h4>Tim Harris, RizePoint Senior Vice President of Product</h4>
				 ...
				 <div class="panel-section">
					<h3>RizePoint Customer Panel Q&amp;A—RizePoint in action from the client’s view</h3>
					<h4>Moderated by Nisha Burke, RizePoint Product Marketing Manager</h4>
		  ...
		  <div class="panel panel-default">
			...
			<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
			  <div class="panel-body">
				<div class="panel-section">
					<h3>Business Intelligence Camp—the reporting rock stars return </h3>
					<h4>Kari Hensien, RizePoint Senior Product Manager</h4>
				...
				<div class="panel-section">
					<h3>Managing Suppliers from Start to Finish—supplier quality management made easy </h3>
					<h4>Sue Caniglia, RizePoint Product Manager</h4>
					<h4>Braden Call, RizePoint Senior Product Manager</h4>
				...
				<div class="panel-section">
					<h3>Designing a Quality Program—new RizePoint tools help you every step of the way</h3>
					<h4>Kari Hensien, RizePoint Senior Product Manager</h4>
				...
				<div class="panel-section">
					<h3>Expert Tips and Tricks—secrets from those who know RizePoint best</h3>
					<h4>Jeremy (JT) Thomas, RizePoint Sales Engineer</h4>
					<h4>Kimball Nelson, RizePoint Sales Engineer</h4>
		  ...
		  <div class="panel panel-default">
			...
			<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
			  <div class="panel-body">
				<div class="panel-section">
					<h3>Brand Experience—deploying the latest in brand protection</h3>
					<h4>Tim Harris, RizePoint Senior Vice President of Product</h4>
				...
				<div class="panel-section">
					<h3>Putting RizePoint Staff to Work for You—an introduction to RizePoint professional services</h3>
					<h4>Gary Ashcraft, RizePoint Senior Director of Customer Success</h4>
				...
				<div class="panel-section">
					<h3>Supplier Management Best Practices—a practical approach to managing your global supply chain</h3>
					<h4>Braden Call, RizePoint Senior Product Manager</h4>
				...
				<div class="panel-section">
					<h3>Global Empowerment—an exploration of RizePoint international use cases</h3>
					<h4>Nisha Burke, RizePoint Product Marketing Manager</h4>
...
<div class="container-fluid e2018-bootcamp wrap push">
	<div class="container e2018-bootcamp-wrapper">
		<h2 class="green-text">Free Boot Camp</h2>
