...
<div class="container-fluid">
	<div class="container content">
			...
			<h4>a. Notices.</h4> Any notice required or permitted to be given will be effective only if it is in writing and will be deemed given upon: (i) personal delivery to the appropriate person at the address set forth in the Order Form, (ii) when received by the addressee if sent by a nationally recognized overnight courier (receipt requested) to the address set forth in the Order Form, or (iii) the first business day after sending by confirmed email, provided that email shall not be sufficient for notices of termination or claims. If notice is sent to RizePoint, an additional copy must be sent to: Timothy B. Anderson, Esq., Jones, Waldo, Holbrook, & McDonough, 301 North 200 East, Suite 3A, St. George, UT 84790.

			<h4>b. Independent Contractors.</h4> The parties are independent contractors and will so represent themselves in all regards. Neither party is the agent of the other and neither may bind the other in any way.

			<h4>c. No Waiver.</h4> Neither party will be deemed to have waived any of its rights under this Agreement by lapse of time or by any statement or representation other than in an explicit written waiver. No waiver of a breach will constitute a waiver of any prior or subsequent breach.

			<h4>d. Force Majeure.</h4> Force Majeure. Neither Party shall be liable for a breach of this Agreement caused by a Force Majeure Events. Following the occurrence of a Force Majeure Event, each Party may terminate this Agreement without any penalty upon three (3) business days’ written notice to the other Party.

			<h4>e. Technology Export.</h4> Subscriber agrees to comply fully with all relevant export laws and regulations of the United States of America. Subscriber represents, warrants and agrees that it will not, directly or indirectly, export, re-export or transmit the Software or data, information, and/or materials resulting from the Service (or direct product thereof) to any country in which such export, re-export or transmission is restricted by any applicable U.S. regulation or statute, without the prior written consent of both RizePoint and, if required, of the Bureau of Export Administration of the U.S. Department of Commerce, or such other governmental entity as may have jurisdiction over such export or transmission.

			<h4>f. Anti-Corruption.</h4> Subscriber acknowledges that it has not received or been offered any illegal or improper bribe, kickback, payment, gift, or thing of value from any employee or agent of RizePoint in connection with this Agreement. Reasonable gifts and entertainment provided in the ordinary course of business do not violate the above restriction. Subscriber agrees to use reasonable efforts to promptly notify RizePoint if it learns of any violation of the above restriction.

			<h4>g. Choice of Law &amp; Jurisdiction.</h4> This Agreement will be governed solely by the internal laws of the State of Utah, without reference to such State’s principles of conflicts of law. The parties consent to the personal and exclusive jurisdiction of the federal and state courts of Salt Lake County, Utah.

			<h4>h. Attorney Fees.</h4> Subscriber agrees to pay on demand all reasonable attorney fees and other costs incurred by RizePoint to collect any fees or charges due under the Order Form. In the event either party shall file suit to enforce the terms of an Order Form or these Terms and Conditions, the prevailing party shall be entitled to the award of reasonable attorney fees and costs.

			<h4>i. Severability.</h4> To the extent permitted by applicable law, the parties hereby waive any provision of law that would render any clause of these Terms and Conditions invalid or otherwise unenforceable in any respect. In the event that a provision is held by a court of competent jurisdiction to be invalid or otherwise unenforceable, such provision will be interpreted to fulfill its intended purpose to the maximum extent permitted by applicable law, and the remaining provisions of these Terms and Conditions will continue in full force and effect.

			<h4>j. Entire Agreement.</h4> The Order Form and these Terms and Conditions set forth the entire agreement of the parties and supersede all prior or contemporaneous writings, negotiations, and discussions with respect to the subject matter thereof. Neither party has relied upon any such prior or contemporaneous communications.		
