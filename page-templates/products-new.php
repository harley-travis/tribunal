	...
	<div class="aud-wrapper">
		<div class="row">
			...
			<div class="col-md-7 col-sm-6 col-xs-12 aud-text">
				...
				<h3>Inspect every location efficiently using a proven, time-tested mobile audit app.</h3>
				<ul>
	...
	<div class="man-wrapper">
		<div class="row">
			...
			<div class="col-md-7 col-sm-6 col-xs-12 man-text">
				...
				<h3>Get everything you want in one complete quality management software.</h3>
				<ul>
